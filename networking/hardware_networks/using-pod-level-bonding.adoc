...
For guidance on tasks such as creating a SR-IOV network, network policies, network attachment definitions and pods, see  xref:../../networking/hardware_networks/configuring-sriov-device#nw-sriov-configuring-device_configuring-sriov-device[Configuring an SR-IOV network device].
