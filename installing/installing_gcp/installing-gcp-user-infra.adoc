...
* xref:../../networking/networking_operators/ingress-operator.adoc#nw-ingress-controller-configuration-gcp-global-access_configuring-ingress[Configure global access for an Ingress Controller on {gcp-short}].
