...
Project:: See "openshift-ingress-operator" in the _Additional resources_ section.

CRDs:: The following parameters describe the clusteringresses.ingress.openshift.io CRD:
...
Configuration objects:: The followign parameters describe the `clusteringresses.ingress.openshift.io` CRD:
...
Notes:: The Ingress Operator sets up the router in the `openshift-ingress` project and creates the deployment for the router:
