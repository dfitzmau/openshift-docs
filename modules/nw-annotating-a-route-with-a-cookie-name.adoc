...
When a server is overloaded, the server redistributes client requests to other endpoints.

.Procedure

. Annotate the route with the specified cookie name by entering the following command:
+
[source,terminal]
----
