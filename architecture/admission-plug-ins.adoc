...
ifndef::openshift-rosa,openshift-dedicated[]
* xref:../networking/networking_operators/sr-iov-operator/configuring-sriov-operator.adoc#nw-sriov-configuring-operator_configuring-sriov-operator[Configuring the SR-IOV Network Operator]
