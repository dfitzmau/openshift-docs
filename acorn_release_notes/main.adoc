...
include::manual-content/ocp-4-13-about-this-release.adoc[leveloffset=+1]

include::manual-content/ocp-support-compatibility.adoc[leveloffset=+1]
...
include::manual-content/revision-history.adoc[leveloffset=+1]
